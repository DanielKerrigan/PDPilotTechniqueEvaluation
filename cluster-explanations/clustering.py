...
def plot_vine_clusters(data, feature, title=None):
    """
    ...
    for cluster_id, cluster in enumerate(feature_data["clusters"]):
        ...
        cluster_subtitle = [
            f"Accuracy = {cluster['accuracy']}, Precision = {cluster['precision']}, Recall = {cluster['recall']}",
            f"{cluster['cluster_size']} instances",
        ]
